import sys
sys.path.append(r"G:\project code\0037\yolov8_stgcn") # 设置未自己的路径
import os
import time
import torch
import pickle
...
data_files = ['data/action_new-set(labelXscrw).pkl',
              "data/action_new-set(labelXscrw).pkl",
              ]
class_names = ["Bench Press", "Dumbbel Shoulder Press", "Dumbbell Lateral Raises",
                "Squats", "Deadlift", "Shoulder rehabilitation", "Lumbar spine rehabilitation",
                "Knee rehabilitation", "Lat Pulldown"]  # 与具体的动作名
